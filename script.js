...
//]]>
//<![CDATA[
$(window).load(function(){$("#loader").fadeOut(),$("#preloader").delay(10).fadeOut("slow"),$("body").delay(10).css({overflow:"visible"})});
$(function(){$(".separator:first").remove(),$(".post-body > img:first").remove()});
$(".popular-posts ul li .item-snippet").each(function(){var t=$(this).text().substr(0,40),s=t.lastIndexOf(" ");s>32&&$(this).text(t.substr(0,s).replace(/[?,!\.-:;]*$/,"..."))});
$("ul#related-summary li img").each(function(){$(this).attr("src",$(this).attr("src").replace('s72-c','s600'))});                                                               
$(".avatar-image-container img").each(function(){$(this).attr("src",$(this).attr("src").replace(/\/s[0-9]+(\-c)?\//,"/w70-h70-c/"))});
$(".item-thumbnail img").each(function(){$(this).attr("src",$(this).attr("src").replace(/\/s[0-9]+(\-c)?\//,"/w80-h80-c/"))});
